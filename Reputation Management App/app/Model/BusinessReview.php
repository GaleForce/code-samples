...
var $virtualFields = array('firstName'=>'SELECT firstname FROM customers c WHERE c.id=BusinessReview.customer_id','lastName'=>'SELECT lastname FROM customers c WHERE c.id=BusinessReview.customer_id');	
 ...
 */
	public $belongsTo = array(
		...
		'Customer' => array(
			...
			'conditions' => array('Customer.is_delete'=>0),
			'fields' => '',
			'order' => ''
		)
	);
