...
<!--Feed Back Setting End -->
  <form method="post" id="frmreview" accept-charset="utf-8" action="<?php echo HTTP_ROOT ?>dashboard/postReview" id="CustomerRatingForm">
...
<textarea class="field text full required form-control review-back" id="pwd" name="data[BusinessReview][ratingdescription]"></textarea>
   ...
   <div class="form-group">
     ...
     <label class="control-label col-sm-8 review-average"><input class="roomselect" type="checkbox"> i am authorizing to post my review and name online.
