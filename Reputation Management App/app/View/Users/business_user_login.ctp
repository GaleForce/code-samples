...
$(document).ready(function(){
   $('#businessUserLoginForm').validate({
         rules:
         {
            "data[User][email]":
            {
...
<!-- BEGIN LOGIN FORM -->
  <?php echo $this->Form->create('User', array('url'=>array('controller'=>'users', 'action'=>'businessUserLogin'))); ?>
    <h3 class="form-title">Business Login</h3>
