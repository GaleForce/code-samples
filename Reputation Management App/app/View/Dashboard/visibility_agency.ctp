...
<!-- BEGIN PAGE HEADER-->
      <h3 class="page-title">
      <?php echo $design['AgencysiteSetting']['sitetitle']; ?> - Visibility Report
      </h3>
      <div class="page-bar">
        ...
        <div class="page-toolbar">
                <div class="wrapTab">
              <?php if(!empty($businessUser)){?> 
   
      <form id="selectbusiness" method="post" action="<?php echo HTTP_ROOT?>dashboard/visibilityAgency/choosebusiness">

      
      <label>Please Select Business:</label>          
          <select class="visibility-selected" name="data[Business][id]" id="choose">
              <option value="">Please select Business</option>
              <?php foreach ($businessUsers as $key => $value) {?>
                  <option value="<?php echo $key ?>" <?php echo $businessUser['Business']['id']==$key?'selected':''; ?>><?php echo $value; ?></option>
              <?php }?>            
          </select>  
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                           <form id="<?php echo str_replace(' ','',$mn);?>" method="post" action="<?php echo HTTP_ROOT?>dashboard/visibilityAgency/<?php echo str_replace(' ','',$mn);?>">
           ...
           <div class="modal fade" id="<?php echo str_replace(' ','',str_replace('.','', str_replace("'",'', $mn)));?>-model" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                           <form id="<?php echo str_replace(' ','',$mn);?>" method="post" action="<?php echo HTTP_ROOT?>dashboard/visibilityAgency/<?php echo str_replace(' ','',str_replace('.','', str_replace("'",'', $mn)));?>">
                            <?php if(in_array($mn, $media)){?>
                              <input type="hidden" name="data[Visibility][id]" value="<?php echo array_search($mn, $media)?>"/>  
                              <input type="hidden" name="data[Visibility][checker_type]" value="<?php echo $media[$mn.'checker']=='SocialSite'?'socialchecker':'visibilitychecker'?>"/>
                              <input type="hidden" name="data[Business][id]" value="<?php echo $businessUser['Business']['id']?>"/>  
