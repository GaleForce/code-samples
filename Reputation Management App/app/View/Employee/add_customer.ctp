							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="">
										...
										<form class="form-horizontal"  accept-charset="utf-8" method="post" id="CustomerAddForm" action="<?php echo HTTP_ROOT?>Employee/addCustomer">
								  ...
								  <div class="col-sm-6">
									<textarea class="field text full form-control form-back" id="pwd" name="data[Customer][notes]"></textarea>
									 ...
									 <div class="form-group">
										...
										<input type="submit" class="submit btn btn-primary" value="Create Customer Account">
									 </div> 
									</div>
