            ...
            <div class="bs-example" data-example-id="bordered-table ">
              ...
              <thead class="tbleHead">
                  <tr>
                    ...
                    <th><?php echo $this->Paginator->sort('agencyname','Agency Name'); ?></th>
                    ...
                    <th class="dash-serial"><?php echo $this->Paginator->sort('AgencysiteSetting.user_type','Status');  ?></th>
                ...
                <?php foreach ($agency_data as $key => $agency) { ?>
                <tr>
                    <td><?php echo h($key+1); ?></td>
                    <td><?php echo h($agency['AgencysiteSetting']['agencyname']); ?>&nbsp;</td>
                    <td><?php echo h($agency['User']['lastlogin']); ?>&nbsp;</td>
                    <td><?php echo h($agency['User']['firstname']); ?>&nbsp;</td>
                    <?php if($agency['AgencysiteSetting']['user_type'] == 0) {?>
                    ...
                    <td><div class="dropdown">
                      ...
                      <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo HTTP_ROOT.'admin/editAgency/'.base64_encode($agency['AgencysiteSetting']['id'])?>">Edit</a></li>
                      
                        <li role="presentation"><a role="menuitem" tabindex="-1" 
                        onclick="if(!confirm('Do you want to delete this record?')){return false;}" title="Delete" href="<?php echo HTTP_ROOT.'admin/delete/AgencysiteSetting/'.base64_encode($agency['AgencysiteSetting']['id'])?>">Delete</a></li>
                       
                         <?php $target = array('0'=>'1','1'=>'0'); ?>
                         <li role="status"><a role="menuitem" tabindex="-1" href="<?php echo HTTP_ROOT.'admin/updatestatus/'.base64_encode($agency['AgencysiteSetting']['id']).'/'.$target[$agency['AgencysiteSetting']['user_type']]?>">Status</a></li>

                         <li role="status"><a role="menuitem" tabindex="-1" href="<?php echo HTTP_ROOT.'admin/business_list/'.base64_encode($agency['AgencysiteSetting']['id'])?>">Business</a></li>
